...
import com.gl.app.Dto.ErrorResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /* It will handle the exception when the registration id is not linked
       with the event id in the table
    */
    @ExceptionHandler(BMSApiException.class)
    ...
    /*
       ...
       for the validation errors for both event and registration entity
    */
    @Override
